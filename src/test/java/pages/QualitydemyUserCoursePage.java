...
public class QualitydemyUserCoursePage extends QualitydemyGirisSayfasiPage{

    public QualitydemyUserCoursePage(){
    ...
    public void reachCourseManagerPage(){
        ...
        if (girisCookieLink.isDisplayed()) {girisCookieLink.click();}
        girisIlkLoginLink.click();
        girisEmailBox.sendKeys(ConfigReader.getProperty("qualityUser"));
        girisPasswordBox.sendKeys(ConfigReader.getProperty("qualityPass"));
        girisLoginLink.click();
